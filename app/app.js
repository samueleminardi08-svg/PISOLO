...
4. LUNGHEZZA: Non c'è limite, ma deve essere naturale (circa 20-40 parole). Scrivi solo la frase, senza asterischi o descrizioni tra parentesi.`;
    ...
    const TRANQUIL_BACKGROUNDS = [
      {"id": "spiaggia-tramonto", "name": "Spiaggia al Tramonto", "emoji": "🌅", "image": "assets/landscapes/bg_01.jpg", "place": "Spiaggia calma al tramonto con sfumature pastello", "themeColor": "#FFE5D9"},
      {"id": "sentiero-bosco", "name": "Sentiero nel Bosco", "emoji": "🌲", "image": "assets/landscapes/bg_02.jpg", "place": "Bosco incantato con raggi di sole", "themeColor": "#EAF8F1"},
      {"id": "lago-alpino", "name": "Lago Alpino", "emoji": "🏔️", "image": "assets/landscapes/bg_03.jpg", "place": "Lago specchio all'aurora tra le montagne", "themeColor": "#E8EAF6"},
      {"id": "notte-stellata", "name": "Notte Stellata", "emoji": "✨", "image": "assets/landscapes/bg_04.jpg", "place": "Prato quieto sotto un immenso cielo stellato", "themeColor": "#E8EAF6"},
      {"id": "nuvole-soffici", "name": "Nuvole Soffici", "emoji": "☁️", "image": "assets/landscapes/bg_05.jpg", "place": "Cielo color pastello, morbido e rilassante", "themeColor": "#FCE4EC"},
      {"id": "finestra-pioggia", "name": "Finestra sulla Pioggia", "emoji": "🌧️", "image": "assets/landscapes/bg_06.jpg", "place": "Finestra accogliente su un giardino bagnato", "themeColor": "#ECEFF1"},
      {"id": "cascata-giungla", "name": "Cascata Segreta", "emoji": "🌿", "image": "assets/landscapes/bg_07.jpg", "place": "Cascata nascosta tra felci rigogliose", "themeColor": "#E0F2F1"},
      {"id": "baita-innevata", "name": "Baita Innevata", "emoji": "❄️", "image": "assets/landscapes/bg_08.jpg", "place": "Baita calda in una foresta coperta di neve", "themeColor": "#E3F2FD"},
      {"id": "oceano-luna", "name": "Oceano e Luna", "emoji": "🌕", "image": "assets/landscapes/bg_09.jpg", "place": "Acqua calma sotto una luna piena luminosa", "themeColor": "#ECEFF1"},
      {"id": "campo-lavanda", "name": "Campo di Lavanda", "emoji": "🪻", "image": "assets/landscapes/bg_10.jpg", "place": "Vastità lilla profumata e pacificante", "themeColor": "#F3E5F5"}
    ];
